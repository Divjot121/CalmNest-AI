...
import { Heart, Mail, Lock, User, Loader2, AlertCircle, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] bg-indigo-50 rounded-full blur-[120px] opacity-70 -z-10" />
      <div className="absolute bottom-[-10%] right-[-5%] w-[500px] h-[500px] bg-emerald-50 rounded-full blur-[120px] opacity-60 -z-10" />
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-slate-500">Join our caring community and start your wellness journey today</p>
        </div>
